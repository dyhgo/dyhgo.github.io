...
window.onload = function () {
    ...
    if(isPC){
        ...
        ele.insertAdjacentHTML("beforebegin", '<iframe frameborder="no" border="0" style="left: 60px; max-width: 260.757px; visibility: visible; position: fixed; top: 100px; height: 480px" src="//music.163.com/outchain/player?type=0&amp;id=3194597807&amp;auto=1&amp;height=600"></iframe>')
    }
