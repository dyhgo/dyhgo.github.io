...
window.onload = function () {
    ...
    // document.write("<script src='https://cdn.jsdelivr.net/gh/nlby/live2dCDN@1.0.2/static/live2dcubismcore.min.js'></script>");
    // document.write("<script src='https://cdn.jsdelivr.net/npm/pixi.js@4.6.1/dist/pixi.min.js'></script>");
    // document.write("<script src='https://cdn.jsdelivr.net/gh/nlby/live2dCDN@1.0.2/static/live2dv3.js'></script>");
    ...
    if(el2[0] != null){
        el2[0].insertAdjacentHTML("beforebegin", '<marquee width="600px"> 放 假 啦 ！！！ /\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\/\\</marquee>');
    }
    ...
    if(isPC){
        ...
        if(ele != null){
            ele.insertAdjacentHTML("beforebegin", '<iframe style="left: 20px; width: 320.757px; visibility: visible; position: fixed; top: 90px; height: 200px" src="//player.bilibili.com/player.html?aid=669567211&bvid=BV1Fa4y1j7kp&cid=235510373&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>\n' +
                '\n' +
                '\n' +
                '\n' +
                '            <iframe frameborder="no" border="0" style="left: 20px; width: 320.757px; visibility: visible; position: fixed; top: 300px; height: 480px" src="//music.163.com/outchain/player?type=0&id=5238229218&auto=0&height=600"></iframe>\n' +
                '\n' +
            ...
            //     basePath: 'https://cdn.jsdelivr.net/gh/nlby/live2dCDN@1.0.2/assets', // 模型根目录
            //     modelName: 'aidang_2', // 模型目录
            //     sizeLimit: false,
            //     mobileLimit: false
            //
            //
        ...
        var tp = document.getElementById('mask');
        if(tp != null){
            tp.insertAdjacentHTML("beforebegin", "<script src='https://cdn.jsdelivr.net/npm/howler@2.1.3/dist/howler.min.js'></script>\n" +
