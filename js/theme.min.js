...
window.onload = function () {
    ...
    if(isPC){
        ...
        if(ele != null){
            ele.insertAdjacentHTML("beforebegin", '<iframe style="left: 20px; width: 320.757px; visibility: visible; position: fixed; top: 90px; height: 200px" src="//player.bilibili.com/player.html?aid=971931050&bvid=BV17p4y1H71V&cid=306277190&page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>\n' +
                '\n' +
                '\n' +
                '\n' +
    ...
    if(el2[0] != null){
        el2[0].insertAdjacentHTML("beforebegin", '<marquee width="500px">新游戏：极限国度、地平线5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;新游戏：极限国度、地平线5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;新游戏：极限国度、地平线5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</marquee>');
    }
