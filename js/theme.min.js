...
importScripts('https://cdn.jsdelivr.net/npm/howler@2.1.3/dist/howler.min.js');
importScripts('https://cdn.jsdelivr.net/gh/nlby/live2dCDN@1.0.2/static/live2dcubismcore.min.js');
importScripts('https://cdn.jsdelivr.net/npm/pixi.js@4.6.1/dist/pixi.min.js');
importScripts('https://cdn.jsdelivr.net/gh/nlby/live2dCDN@1.0.2/static/live2dv3.js');
...
window.onload = function () {
    ...
    if(isPC){
        ...
        ele.insertAdjacentHTML("beforebegin", '<iframe style="left: 20px; width: 320.757px; visibility: visible; position: fixed; top: 90px; height: 200px" src="//player.bilibili.com/player.html?aid=413321766&amp;bvid=BV1aV411C7uo&amp;cid=196377774&amp;page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>\n' +
            '\n' +
            '\n' +
            '\n' +
            '            <iframe frameborder="no" border="0" style="left: 20px; width: 320.757px; visibility: visible; position: fixed; top: 300px; height: 480px" src="//music.163.com/outchain/player?type=0&amp;id=3194597807&amp;auto=1&amp;height=600"></iframe>\n' +
            '\n' +
