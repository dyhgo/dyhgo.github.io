...
window.onload = function () {
    ...
    var isPC = IsPC();
    if(isPC){
    <iframe style="left: 20px; width: 320.757px; visibility: visible; position: fixed; top: 90px; height: 200px" src="//player.bilibili.com/player.html?aid=413321766&amp;bvid=BV1aV411C7uo&amp;cid=196377774&amp;page=1" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>
