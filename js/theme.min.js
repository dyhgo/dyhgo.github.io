...
window.onload = function () {
    ...
    if(el2[0] != null){
        el2[0].insertAdjacentHTML("beforebegin", '<marquee width="500px"> 放假了~                  放假了~                        放假了~               </marquee>');
    }

    var el3 = document.getElementsByTagName('body');
    if(el3[0] != null){
        el3[0].insertAdjacentHTML("afterbegin", '<script type = "text/javascript" src="https://unpkg.com/magic-snowflakes/dist/snowflakes.min.js"></script>\n' +
